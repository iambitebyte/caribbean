...
import { Activity, Cpu, RefreshCw, Server, Plug, Clock, Pencil, Zap } from "lucide-react"
                        ...
                        >
                          ...
                          <TableCell>
                            {node.status?.openclawGateway ? (
                              <Badge variant={node.status.openclawGateway === 'running' ? "success" : "destructive"} className="whitespace-nowrap">
